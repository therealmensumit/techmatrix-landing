...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-RF2LC5J4P5"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-RF2LC5J4P5');
</script>
...
})(window,document,'script','dataLayer','GTM-NBGPLLW');</script>
